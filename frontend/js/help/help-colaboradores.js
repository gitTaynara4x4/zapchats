(function () {
  ...
  const CFG = {
    "key": "colaboradores",
    "page": "Colaboradores",
    "title": "Entenda os Colaboradores",
    "intro": "Vou te mostrar onde ficam busca, indicadores, cadastro e lista da equipe.",
    "robotName": "Zappy",
    "robotSrc": "/frontend/img/help/zc-robot-floating.png",
    "storageKey": "zaps_help_colaboradores_robot_tour_seen_v1",
    "steps": [
        {
            "title": "Resumo da página",
            "say": "Aqui você confirma que está gerenciando os colaboradores da empresa.",
            "desc": "O topo mostra a área atual e o total de usuários carregados, deixando claro que esta tela é para organizar a equipe.",
            "icon": "users",
            "selectors": [
                ".colab-title-block",
                ".colab-top",
        ...
        },
        {
            ...
            "say": "Quando a equipe crescer, comece procurando por aqui.",
            "desc": "Use a busca para localizar por nome, e-mail ou cargo, e filtre por departamento para chegar mais rápido no colaborador certo.",
            "icon": "filter",
            "selectors": [
                ".colab-searchbar",
                "#filtro",
        ...
        },
        {
            ...
            "say": "Esses cards dão uma leitura rápida do estado da sua equipe.",
            "desc": "Aqui você vê total, ativos, pendentes, selecionados e a opção de segurança extra por código de login no e-mail.",
            "icon": "chart",
            "selectors": [
                ".colab-stats",
                ".stat-card-security",
        ...
        },
        {
            ...
            "say": "Esse é o ponto para cadastrar ou exportar colaboradores.",
            "desc": "Use Novo colaborador para criar um acesso para alguém da equipe. Exportar baixa a lista atual para conferência externa.",
            "icon": "userPlus",
            "selectors": [
                ".colab-top-actions",
                "#btn-add-colaborador",
                "#btn-export-colaboradores"
            ]
        },
        {
            "title": "Tabela da equipe",
            "say": "A lista central é onde você acompanha e edita cada colaborador.",
            "desc": "Na tabela ficam nome, e-mail, cargo, departamentos, status e as ações de edição/permissão de cada colaborador.",
            "icon": "list",
            "selectors": [
                ".colab-table-panel",
                ".table-wrap",
  ...
  const NS = 'zc-robot-tour-colaboradores';
  let stepIndex = 0;
  let raf = 0;
  let scrollTimer = 0;
