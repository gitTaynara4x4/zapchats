(function () {
  ...
  const CFG = {
    "key": "chatbot",
    "page": "Chatbot",
    "title": "Entenda seu Chatbot",
    "intro": "Vou te mostrar como escolher a instância, configurar respostas, menu de departamentos e testar antes de salvar.",
    "robotName": "Zappy",
    "robotSrc": "/frontend/img/help/zc-robot-floating.png",
    "storageKey": "zaps_help_chatbot_robot_tour_seen_v1",
    "steps": [
        {
            "title": "Resumo da página",
            "say": "Aqui você confirma que está na configuração do Chatbot.",
            "desc": "O topo mostra a instância selecionada, status de salvamento, ajuda, teste e o botão para salvar a automação.",
            "icon": "grid",
            "selectors": [
                ".chatbot-title-block",
                ".chatbot-top",
        ...
        {
            "title": "Instância do WhatsApp",
            "say": "Antes de configurar, escolha qual WhatsApp vai usar essa automação.",
            "desc": "A instância selecionada define onde as mensagens automáticas e o menu de departamentos serão aplicados.",
            "icon": "filter",
            "selectors": [
                "#instMenuBtnChat",
                ".inst-wrap",
        ...
        {
            "title": "Resposta automática simples",
            "say": "Esse modo serve para boas-vindas e aviso fora do horário.",
            "desc": "Ative o card, defina horários e escreva as mensagens que o cliente receberá automaticamente.",
            "icon": "chat",
            "selectors": [
                "#it-auto",
                "#swAutoHdr",
        ...
        {
            "title": "Menu de departamentos",
            "say": "Aqui o cliente escolhe para qual setor quer falar.",
            "desc": "Você configura a mensagem inicial, escolhe os departamentos disponíveis e o atendimento é encaminhado para a equipe certa.",
            "icon": "list",
            "selectors": [
                "#it-auto-dept",
                "#swDeptHdr",
        ...
        {
            "title": "Preview e resumo",
            "say": "Use esse lado para conferir antes de colocar em produção.",
            "desc": "O preview simula como o cliente verá a mensagem no WhatsApp, e o resumo mostra o estado da configuração atual.",
            "icon": "chart",
            "selectors": [
                ".chatbot-aside",
                ".preview-side-card",
        ...
        },
        {
            ...
            "say": "Depois de revisar, salve e teste para garantir que ficou certo.",
            "desc": "O botão Salvar grava a configuração da instância. O teste ajuda a validar o comportamento antes do cliente real usar.",
            "icon": "check",
            "selectors": [
                "#saveGlobal",
                "#helpChatbotBtn",
  ...
  const NS = 'zc-robot-tour-chatbot';
  let stepIndex = 0;
  let raf = 0;
  let scrollTimer = 0;
