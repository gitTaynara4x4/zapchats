(function () {
  ...
  const CFG = {
    "key": "midias",
    "page": "Mídias",
    "title": "Entenda suas Mídias",
    "intro": "Vou te mostrar como localizar, enviar e organizar arquivos nesta biblioteca.",
    "robotName": "Zappy",
    "robotSrc": "/frontend/img/help/zc-robot-floating.png",
    "storageKey": "zaps_help_midias_robot_tour_seen_v1",
    "steps": [
        {
            "title": "Resumo da página",
            "say": "Aqui é sua biblioteca de arquivos: imagens, vídeos, áudios e documentos.",
            "desc": "No topo você confirma que está em Mídias e escolhe o escopo dos arquivos que quer visualizar.",
            "icon": "grid",
            "selectors": [
                ".midias-title-block",
                ".midias-top h1",
        ...
        },
        {
            ...
            "say": "Esses botões são os atalhos para filtrar, enviar ou limpar arquivos.",
            "desc": "Use “Meus Arquivos” para ver seus itens, “Enviar” para subir novas mídias e “Limpar” para remover filtros/seleções da visualização.",
            "icon": "send",
            "selectors": [
                ".midias-top-actions",
                "#btn-upload",
        ...
        {
            "title": "Busca rápida",
            "say": "Quando tiver muitos arquivos, comece pesquisando por aqui.",
            "desc": "A busca ajuda a encontrar arquivos por nome, cliente, telefone ou tags, sem precisar navegar manualmente na lista.",
            "icon": "search",
            "selectors": [
                ".midias-searchbar",
                "#q",
        ...
        },
        {
            ...
            "say": "Essa área mostra o que entrou ou foi usado mais recentemente.",
            "desc": "Os arquivos recentes aceleram o acesso aos últimos envios e recebimentos da operação.",
            "icon": "clock",
            "selectors": [
                ".recent-panel",
                "#midias-list",
        ...
        {
            "title": "Lista e filtros por tipo",
            "say": "Aqui você separa tudo por documento, imagem, vídeo ou áudio.",
            "desc": "Use as abas para filtrar o tipo de mídia e acompanhe na tabela a origem, modificação e ações disponíveis de cada arquivo.",
            "icon": "filter",
            "selectors": [
                ".files-panel",
                ".tabs",
        ...
        },
        {
            ...
            "say": "Selecionou um arquivo? Os detalhes aparecem neste painel lateral.",
            "desc": "O painel mostra prévia, tipo, data e resumo do arquivo selecionado, deixando a conferência mais rápida.",
            "icon": "file",
            "selectors": [
                "#file-detail-panel",
                ".file-aside",
