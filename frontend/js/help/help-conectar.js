(function () {
  ...
  const CFG = {
    "key": "conectar",
    "page": "Conectar",
    "title": "Entenda a tela Conectar",
    "intro": "Vou te mostrar como acompanhar números, conectar outro WhatsApp e identificar quando uma instância precisa de atenção.",
    "robotName": "Zappy",
    "robotSrc": "/frontend/img/help/zc-robot-floating.png",
    "storageKey": "zaps_help_conectar_robot_tour_seen_v1",
    "steps": [
        {
            "title": "Resumo da página",
            "say": "Aqui você acompanha os números de WhatsApp conectados ao ZapsChat.",
            "desc": "O topo mostra a página atual e o total de números usados no plano. É o ponto de partida para gerenciar suas conexões.",
            "icon": "grid",
            "selectors": [
                ".section-title",
                ".top-total",
        ...
        {
            "title": "Resumo dos números",
            "say": "Esses cards mostram rapidamente o que está ativo e o que precisa de atenção.",
            "desc": "Use o resumo para identificar números ativos, QR Code pendente e instâncias que precisam reconectar.",
            "icon": "chart",
            "selectors": [
                ".zc-smart-summary",
                ".zc-smart-card",
        ...
        },
        {
            ...
            "say": "Aqui você alterna entre números ativos e inativos sem sair da página.",
            "desc": "As abas ajudam a separar números em uso dos números pausados ou desconectados.",
            "icon": "filter",
            "selectors": [
                ".tabs",
                "#tab-ativos",
        ...
        },
        {
            ...
            "say": "Quando precisar conectar outro WhatsApp, comece por esse botão.",
            "desc": "Ele abre o fluxo de conexão, onde você informa o apelido, escolhe o histórico e gera QR Code ou código de pareamento.",
            "icon": "userPlus",
            "selectors": [
                "#btn-open-modal",
                ".actions",
        ...
        },
        {
            ...
            "say": "Depois de conectar, seus números aparecem aqui para acompanhamento e ações rápidas.",
            "desc": "A tabela mostra apelido, número, plano, status e ações como editar, remover, reconectar ou analisar saúde do número.",
            "icon": "list",
            "selectors": [
                ".table-wrap",
                "#lista-zap",
        ...
        },
        {
            ...
            "say": "Se o cliente travar no QR Code, use essa ajuda para orientar o passo a passo.",
            "desc": "A ajuda explica como abrir o WhatsApp, acessar dispositivos conectados e escanear o QR Code do ZapsChat.",
            "icon": "help",
            "selectors": [
                "#btn-open-help",
                "[data-help-open]",
  ...
  const NS = 'zc-robot-tour-conectar';
  let stepIndex = 0;
  let raf = 0;
  let scrollTimer = 0;
  ...
  function build() {
    ...
    shell.innerHTML = `
      ...
      <div class="zc-robot-tour-stage" aria-live="polite" data-position="right">
        ...
        <section class="zc-robot-tour-card" role="dialog" aria-modal="false" aria-label="Ajuda guiada de Conectar">
    ...
    document.querySelectorAll('.js-help-open').forEach(function (el) {
