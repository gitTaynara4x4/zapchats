(function () {
  ...
  const CFG = {
    "key": "departamentos",
    "page": "Departamentos",
    "title": "Entenda os Departamentos",
    "intro": "Vou te mostrar como visualizar a estrutura da empresa e criar setores sem se perder.",
    "robotName": "Zappy",
    "robotSrc": "/frontend/img/help/zc-robot-floating.png",
    "storageKey": "zaps_help_departamentos_robot_tour_seen_v1",
    "steps": [
        {
            "title": "Resumo da estrutura",
            "say": "Essa tela mostra a organização da empresa em formato de estrutura.",
            "desc": "O topo identifica a página de departamentos, onde você organiza setores, equipes, horários e canais de atendimento.",
            "icon": "grid",
            "selectors": [
                ".dept-topbar-title",
                ".dept-topbar",
        ...
        {
            "title": "Adicionar e pesquisar",
            "say": "Aqui ficam as ações rápidas para criar e encontrar departamentos.",
            "desc": "Use Adicionar para criar um novo departamento e a busca para localizar setores existentes na estrutura.",
            "icon": "userPlus",
            "selectors": [
                ".dept-topbar-actions",
                "#btn-add",
        ...
        {
            "title": "Organograma",
            "say": "No centro você enxerga a hierarquia dos departamentos.",
            "desc": "O organograma ajuda a entender onde cada setor fica dentro da empresa e facilita navegar pela estrutura visualmente.",
            "icon": "chart",
            "selectors": [
                ".dept-canvas",
                "#org-container",
        ...
        },
        {
            ...
            "say": "Esses controles ajudam a ajustar a visão quando a estrutura ficar grande.",
            "desc": "Use zoom para aproximar ou afastar o organograma e centralizar a estrutura quando precisar reorganizar a visualização.",
            "icon": "filter",
            "selectors": [
                ".org-controls",
                "#org-zoom-label",
        ...
        },
        {
            ...
            "say": "Quando você seleciona um departamento, os detalhes aparecem aqui.",
            "desc": "O painel lateral concentra informações do departamento selecionado, como equipe, disponibilidade, instâncias e ações relacionadas.",
            "icon": "list",
            "selectors": [
                "#dept-side-panel",
                ".dept-side-panel"
  ...
  const NS = 'zc-robot-tour-departamentos';
  let stepIndex = 0;
  let raf = 0;
  let scrollTimer = 0;
