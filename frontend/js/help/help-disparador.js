(function () {
  ...
  const CFG = {
    "key": "disparador",
    "page": "Disparos",
    "title": "Entenda seus Disparos",
    "intro": "Vou te mostrar como escolher o WhatsApp, montar a mensagem, adicionar contatos e iniciar com segurança.",
    "robotName": "Zappy",
    "robotSrc": "/frontend/img/help/zc-robot-floating.png",
    "storageKey": "zaps_help_disparador_robot_tour_seen_v1",
    "steps": [
        {
            "title": "Resumo da página",
            "say": "Aqui você acompanha a tela de disparos e o total encontrado.",
            "desc": "O topo explica que esta página envia mensagens em fila com intervalo e histórico para acompanhamento.",
            "icon": "grid",
            "selectors": [
                ".section-title",
                ".title-wrap",
        ...
        },
        {
            ...
            "say": "Primeiro escolha a instância que vai fazer o envio.",
            "desc": "O disparo só deve começar depois de selecionar o WhatsApp correto para evitar envio pela instância errada.",
            "icon": "filter",
            "selectors": [
                ".box-hero",
                "#instMenuBtn",
        ...
        {
            "title": "Mensagem do disparo",
            "say": "Aqui você escreve o texto que será enviado para os contatos.",
            "desc": "Use modelos rápidos, exemplo, limpeza de rascunho ou melhoria com IA para criar uma mensagem mais natural.",
            "icon": "chat",
            "selectors": [
                "#msgDisparo",
                ".template-bar",
        ...
        {
            "title": "Contatos de destino",
            "say": "Agora coloque os números que vão receber a mensagem.",
            "desc": "Você pode colar números, importar arquivo ou adicionar clientes cadastrados. O sistema também remove duplicados.",
            "icon": "users",
            "selectors": [
                "#numsDisparos",
                ".numbers-area",
        ...
        {
            "title": "Intervalo e revisão",
            "say": "Essa parte ajuda a enviar com mais segurança.",
            "desc": "Confira o intervalo entre envios e revise total, válidos, suspeitos e estimativas antes de iniciar.",
            "icon": "file",
            "selectors": [
                "#delaySegundos",
                ".config-side",
        ...
        {
            "title": "Iniciar e acompanhar",
            "say": "Quando tudo estiver certo, inicie e acompanhe pelo histórico.",
            "desc": "O botão inicia o envio. Depois, o histórico permite acompanhar disparos criados e reaproveitar configurações.",
            "icon": "check",
            "selectors": [
                "#btnDisparar",
                "#statusDisparos",
  ...
  const NS = 'zc-robot-tour-disparador';
  let stepIndex = 0;
  let raf = 0;
  let scrollTimer = 0;
