(function () {
  ...
  const CFG = {
    "key": "chat-interno",
    "page": "Chat Interno",
    "title": "Entenda o Chat Interno",
    "intro": "Vou te mostrar onde ficam conversas, grupos, filtros e envio de mensagens da equipe.",
    "robotName": "Zappy",
    "robotSrc": "/frontend/img/help/zc-robot-floating.png",
    "storageKey": "zaps_help_chat_interno_robot_tour_seen_v1",
    "steps": [
        {
            "title": "Menu do chat interno",
            "say": "Comece por aqui para alternar entre chats, grupos, menções e contatos.",
            "desc": "O menu lateral organiza as principais seções do chat interno e também mostra os favoritos da equipe.",
            "icon": "chat",
            "selectors": [
                ".workspace-rail",
                ".rail-nav",
        ...
        {
            "title": "Busca rápida",
            "say": "Use essa busca para achar conversas ou pessoas sem perder tempo.",
            "desc": "Digite o nome do colaborador, grupo ou conversa para filtrar rapidamente os resultados.",
            "icon": "search",
            "selectors": [
                ".rail-search",
                "#inpSearch"
        ...
        },
        {
            ...
            "say": "Aqui aparecem as conversas disponíveis para abrir.",
            "desc": "A lista mostra os chats da equipe. Ao selecionar uma conversa, o painel principal é atualizado.",
            "icon": "list",
            "selectors": [
                ".conversation-pane",
                "#listaConversas",
        ...
        {
            "title": "Criar grupo e filtrar",
            "say": "Esses botões ajudam a organizar melhor o atendimento interno.",
            "desc": "Use “Criar grupo” para montar conversas com várias pessoas e “Filtrar” para encontrar conversas específicas.",
            "icon": "filter",
            "selectors": [
        ...
        },
        {
            ...
            "say": "Quando você escolhe uma conversa, ela abre aqui no centro.",
            "desc": "Este painel exibe o histórico de mensagens, dados do contato e ações da conversa selecionada.",
            "icon": "chat",
            "selectors": [
                ".chat-pane",
                ".chat-head",
        ...
        },
        {
            ...
            "say": "Pra responder, escreva aqui e use os atalhos de menção, anexo e envio.",
            "desc": "O compositor permite escrever mensagens, mencionar pessoas, anexar arquivos e enviar para a conversa ativa.",
            "icon": "send",
            "selectors": [
                ".composer",
                "#txtMsg",
        ...
        {
            "title": "Perfil da conversa",
            "say": "Este painel lateral mostra informações do contato selecionado.",
            "desc": "Quando uma conversa está ativa, o perfil ajuda a conferir telefone, e-mail, setor e outras informações do colaborador.",
            "icon": "user",
            "selectors": [
                "#profilePanel",
                ".profile-pane",
  ...
  const NS = 'zc-robot-tour-chat-interno';
  let stepIndex = 0;
  let raf = 0;
  let scrollTimer = 0;
